...
3. **If it’s stuck, flex with care.**  
   Our printers use removable magnetic sheets. Remove the build plate using the tab on the front, bend it just enough to pop the print loose, then immediately put it back. Always keep hold of the sheet—don’t set it down on a table where it might warp.
