...
- **Optional sanding.**
  If desired, prints may be sanded for a smoother finish-however this is not required and sandpaper isn't provided. Use fine-grit sandpaper (220–400 grit) to gently sand away layer lines or rough spots. Sand in small circles and avoid over-sanding details. Be sure to work over a trash bin to keep the lab clean.
