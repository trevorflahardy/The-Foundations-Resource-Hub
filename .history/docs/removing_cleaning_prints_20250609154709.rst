...
2. **Use light, even pressure.**  
   Attempt to pop prints off the plate without tools. If this doesn't work, slide a plastic putty knife beneath the edge of the print and gently rock it back and forth-never pry from one corner only.
