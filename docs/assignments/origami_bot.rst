...
- The :ref:`H-Bridge Control Example <h_bridge>` in this resource hub for more information on controlling DC motors with an H-Bridge.
...
additional comments about what the code is doing, as well as align with this resource hub's
standards.
